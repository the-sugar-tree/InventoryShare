 ...
 */
package com.sugar_tree.inventoryshare.v1_19_R2;
...
import static com.sugar_tree.inventoryshare.v1_19_R2.FileManager_1_19_R2.*;

public class Inventory_1_19_R2 implements Inventory {

    public void invApplyAll(@NotNull Player p) {
        EntityPlayer entityPlayer = ((CraftPlayer) p).getHandle();
        PlayerInventory playerInventory = entityPlayer.fE();
        try {
    ...
    public void savePlayerInventory(@NotNull Player p) {
        ...
        EntityPlayer entityPlayer = ((CraftPlayer) p).getHandle();
        try {
            setField(pinv, "h", entityPlayer.fE().h);
            setField(pinv, "i", entityPlayer.fE().i);
            setField(pinv, "j", entityPlayer.fE().j);
            setField(pinv, "n", ImmutableList.of(entityPlayer.fE().h, entityPlayer.fE().i, entityPlayer.fE().j));
        } catch (Exception e) {
            e.printStackTrace();
        }
