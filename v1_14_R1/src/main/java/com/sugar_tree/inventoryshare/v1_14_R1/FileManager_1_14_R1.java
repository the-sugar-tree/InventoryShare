...
public class FileManager_1_14_R1 implements FileManager {
    ...
    protected static NonNullList<ItemStack> armor = NonNullList.a(4, ItemStack.a);
    protected static NonNullList<ItemStack> extraSlots = NonNullList.a(1, ItemStack.a);
    ...
    public void load() {
        ...
        for (Team team : Bukkit.getServer().getScoreboardManager().getMainScoreboard().getTeams()) {
            NonNullList<ItemStack> items = NonNullList.a(36, ItemStack.a);
            NonNullList<ItemStack> armor = NonNullList.a(4, ItemStack.a);
            NonNullList<ItemStack> extraSlots = NonNullList.a(1, ItemStack.a);
            File file = new File(new File(plugin.getDataFolder(), "\\teams"), team.getName() + ".yml");
            if (file.exists()) {
                FileConfiguration fileConfiguration = YamlConfiguration.loadConfiguration(file);
